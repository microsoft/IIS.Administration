...
namespace Microsoft.IIS.Administration.WebServer.Authentication
{
    ...
    public class AnonAuthId
    {
        private const string PURPOSE = "WebServer.Authentication.AnonymousAuthentication";
        ...
        public AnonAuthId(long? siteId, string path, bool isLocal)
        {
