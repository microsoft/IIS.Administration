...
namespace Microsoft.IIS.Administration.WebServer.Authentication
{
    ...
    public class BasicAuthId
    {
        private const string PURPOSE = "WebServer.Authentication.BasicAuthentication";
        ...
        public BasicAuthId(string uuid)
        {
        ...
        public BasicAuthId(long? siteId, string path, bool isLocal)
        {
