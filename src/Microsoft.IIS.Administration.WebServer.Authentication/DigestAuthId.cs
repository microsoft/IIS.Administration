...
namespace Microsoft.IIS.Administration.WebServer.Authentication
{
    ...
    public class DigestAuthId
    {
        private const string PURPOSE = "WebServer.Authentication.DigestAuthentication";
        ...
        public DigestAuthId(string uuid)
        {
        ...
        public DigestAuthId(long? siteId, string path, bool isLocal)
        {
