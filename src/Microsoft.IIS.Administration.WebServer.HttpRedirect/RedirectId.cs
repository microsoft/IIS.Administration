...
namespace Microsoft.IIS.Administration.WebServer.HttpRedirect
{
    ...
    public class RedirectId
    {
        ...
        public RedirectId(long? siteId, string path, bool isLocal)
        {
