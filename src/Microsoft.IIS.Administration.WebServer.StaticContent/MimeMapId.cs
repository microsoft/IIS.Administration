...
namespace Microsoft.IIS.Administration.WebServer.StaticContent
{
    ...
    public class MimeMapId
    {
        private const string PURPOSE = "WebServer.StaticContent.MimeMaps";
        ...
        public MimeMapId(long? siteId, string path, string fileExtension)
        {
