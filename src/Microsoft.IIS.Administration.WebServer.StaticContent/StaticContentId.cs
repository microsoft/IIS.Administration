...
namespace Microsoft.IIS.Administration.WebServer.StaticContent
{
    ...
    public class StaticContentId
    {
        private const string PURPOSE = "WebServer.StaticContent";
        ...
        public StaticContentId(string uuid)
        {
        ...
        public StaticContentId(long? siteId, string path, bool isLocal)
        {
