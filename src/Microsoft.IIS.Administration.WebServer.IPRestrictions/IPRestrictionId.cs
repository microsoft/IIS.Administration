...
namespace Microsoft.IIS.Administration.WebServer.IPRestrictions
{
    ...
    public class IPRestrictionId
    {
        private const string PURPOSE = "WebServer.IPRestrictions";
        ...
        public IPRestrictionId(string uuid)
        {
        ...
        public IPRestrictionId(long? siteId, string path, bool isLocal)
        {
