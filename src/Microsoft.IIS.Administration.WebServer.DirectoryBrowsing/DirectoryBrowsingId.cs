...
namespace Microsoft.IIS.Administration.WebServer.DirectoryBrowsing
{
    ...
    public class DirectoryBrowsingId
    {
        private const string PURPOSE = "WebServer.DirectoryBrowsing";
        ...
        public DirectoryBrowsingId(string uuid)
        {
        ...
        public DirectoryBrowsingId(long? siteId, string path, bool isLocal)
        {
