...
namespace Microsoft.IIS.Administration.WebServer.UrlRewrite
{
    ...
    public class InboundRulesSectionId
    {
        private const string PURPOSE = "WebServer.UrlRewrite.InboundRules";
        ...
        public InboundRulesSectionId(string uuid)
        {
        ...
        public InboundRulesSectionId(long? siteId, string path)
        {
