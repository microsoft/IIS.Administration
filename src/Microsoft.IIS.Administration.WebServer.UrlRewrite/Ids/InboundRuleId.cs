...
namespace Microsoft.IIS.Administration.WebServer.UrlRewrite
{
    ...
    public class InboundRuleId
    {
        private const string PURPOSE = "WebServer.UrlRewrite.InboundRule";
        ...
        public InboundRuleId(string uuid)
        {
        ...
        public InboundRuleId(long? siteId, string path, string name)
        {
