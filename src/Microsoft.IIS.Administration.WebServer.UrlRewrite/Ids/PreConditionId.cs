...
namespace Microsoft.IIS.Administration.WebServer.UrlRewrite
{
    ...
    {
        private const string PURPOSE = "WebServer.UrlRewrite.PreCondition";
        ...
        public PreConditionId(string uuid)
        {
        ...
        public PreConditionId(long? siteId, string path, string name)
        {
