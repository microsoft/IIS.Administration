...
namespace Microsoft.IIS.Administration.WebServer.HttpRequestTracing
{
    ...
    public class HttpRequestTracingId
    {
        private const string PURPOSE = "WebServer.HttpRequestTracing";
        ...
        public HttpRequestTracingId(string uuid)
        {
        ...
        public HttpRequestTracingId(long? siteId, string path, bool isLocal)
        {
