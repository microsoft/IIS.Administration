...
namespace Microsoft.IIS.Administration.WebServer.DefaultDocuments
{
    ...
    public class DefaultDocumentId
    {
        private const string PURPOSE = "WebServer.DefaultDocuments";
        ...
        public DefaultDocumentId(string uuid)
        {
        ...
        public DefaultDocumentId(long? siteId, string path, bool isLocal)
        {
