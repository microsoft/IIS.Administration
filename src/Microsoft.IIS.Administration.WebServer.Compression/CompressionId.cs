...
namespace Microsoft.IIS.Administration.WebServer.Compression
{
    ...
    public class CompressionId
    {
        private const string PURPOSE = "WebServer.Compression";
        ...
        public CompressionId(string uuid)
        {
        ...
        public CompressionId(long? siteId, string path, bool isLocal)
        {
