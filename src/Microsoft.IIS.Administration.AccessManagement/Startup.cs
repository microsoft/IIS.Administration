...
namespace Microsoft.IIS.Administration.AccessManagement { 
    ...
    public class Startup : BaseModule
    {
        ...
        private void ConfigureMyToken() {
            _ = Environment.Host.RouteBuilder.MapWebApiRoute(Defines.MyTokenResource.Guid, $"{Defines.MYTOKEN_PATH}", new { controller = "MyToken" });
        ...
        private void ConfigureApiKeys() {
            _ = Environment.Host.RouteBuilder.MapWebApiRoute(Defines.ApiKeysResource.Guid, $"{Defines.APIKEYS_PATH}/{{id?}}", new { controller = "ApiKeys" });
        ...
        private void ConfigureAccessTokens() {
            _ = Environment.Host.RouteBuilder.MapWebApiRoute(Defines.AccessTokensResource.Guid, $"{Defines.ACCESSTOKENS_PATH}/{{id?}}", new { controller = "AccessTokens" });
