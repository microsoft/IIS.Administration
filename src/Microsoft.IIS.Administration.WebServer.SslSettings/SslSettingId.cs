...
namespace Microsoft.IIS.Administration.WebServer.SslSettings
{
    ...
    public class SslSettingId
    {
        private const string PURPOSE = "WebServer.SslSettings";
        ...
        public SslSettingId(string uuid)
        {
        ...
        public SslSettingId(long? siteId, string path, bool isLocal)
        {
