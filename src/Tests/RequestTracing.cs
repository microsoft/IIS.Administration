...
namespace Tests
{
    ...
    {
        public static readonly string REQUEST_TRACING_URL = $"{Globals.TEST_SERVER}:{Globals.TEST_PORT}/api/webserver/http-request-tracing";
        ...
        public void CreatePatchRemoveRule()
        {
            ...
            using (var client = ApiHttpClient.Create($"{Globals.TEST_SERVER}:{Globals.TEST_PORT}")) {
