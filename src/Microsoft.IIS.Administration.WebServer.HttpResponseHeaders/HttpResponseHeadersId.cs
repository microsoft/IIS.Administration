...
namespace Microsoft.IIS.Administration.WebServer.HttpResponseHeaders
{
    ...
    public class HttpResponseHeadersId
    {
        private const string PURPOSE = "WebServer.HttpResponseHeaders";
        ...
        public HttpResponseHeadersId(string uuid)
        {
            ...
            IsLocal = int.Parse(isLocal) == 1;
            this.Uuid = uuid;
        }

        public HttpResponseHeadersId(long? siteId, string path, bool isLocal)
        {
