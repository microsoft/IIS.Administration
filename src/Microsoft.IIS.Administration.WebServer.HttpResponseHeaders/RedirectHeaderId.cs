...
namespace Microsoft.IIS.Administration.WebServer.HttpResponseHeaders
{
    ...
    public class RedirectHeaderId
    {
        private const string PURPOSE = "WebServer.HttpResponseHeaders.RedirectHeader";
        ...
        public RedirectHeaderId(string uuid)
        {
        ...
        public RedirectHeaderId(long? siteId, string path, string name)
        {
