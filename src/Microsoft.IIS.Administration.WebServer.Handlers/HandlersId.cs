...
namespace Microsoft.IIS.Administration.WebServer.Handlers
{
    ...
    public class HandlersId
    {
        private const string PURPOSE = "WebServer.Handlers";
        ...
        public HandlersId(long? siteId, string path, bool isLocal)
        {
